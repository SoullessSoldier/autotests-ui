...
class TestAuthorization:
    ...
    def test_wrong_email_or_password_authorization(self,
        ...
        # allure.dynamic.title('Attempt to login with email: %s' % email)
        login_page.visit('https://nikita-filonov.github.io/'
    ...
    def test_successful_authorization(self,
        ...
        """Метод проверяет успешную авторизацию в приложении."""
        ...
        login_page.login_form.fill(email='user.name@gmail.com',
                                   password='password')
        login_page.click_login_button()
    ...
    def test_navigate_from_authorization_to_registration(
        ...
        """Метод проверяет навигацию со страницы авторизации на регистрацию."""
        login_page.visit('https://nikita-filonov.github.io/'
                         'qa-automation-engineer-ui-course/'
                         '#/auth/login')
